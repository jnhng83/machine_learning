...
W1 = tf.get_variable('W1', shape=[784, L], initializer=tf.contrib.layers.variance_scaling_initializer(), regularizer=tf.contrib.layers.l2_regularizer(scale=0.001))
W2 = tf.get_variable('W2', shape=[L, M], initializer=tf.contrib.layers.variance_scaling_initializer(), regularizer=tf.contrib.layers.l2_regularizer(scale=0.001))
W3 = tf.get_variable('W3', shape=[M, N], initializer=tf.contrib.layers.variance_scaling_initializer(), regularizer=tf.contrib.layers.l2_regularizer(scale=0.001))
W4 = tf.get_variable('W4', shape=[N, O], initializer=tf.contrib.layers.variance_scaling_initializer(), regularizer=tf.contrib.layers.l2_regularizer(scale=0.001))
W5 = tf.get_variable('W5', shape=[O, 10], initializer=tf.contrib.layers.variance_scaling_initializer(), regularizer=tf.contrib.layers.l2_regularizer(scale=0.001))
